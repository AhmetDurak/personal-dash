...
import { IconEdit, IconClose, IconDashboard, IconWorkout, IconClipboard, IconTarget, IconTrophy, IconScale, IconCalendarDay, IconMenu } from '../lib/icons'
  ...
  return (
    <div className="flex flex-col h-full bg-xero-bg overflow-hidden">
      <header className="flex items-center gap-1 px-3 py-2.5 bg-white border-b border-xero-border flex-shrink-0 overflow-hidden">
        ...
        <span className="text-sm font-semibold text-gray-900 flex-shrink-0 mr-1">{t.sport}</span>
